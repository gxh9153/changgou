...
public class ${Table}ServiceImpl implements ${Table}Service {
     ...
     */
    @Override
    public List<${Table}> findPage(${Table} ${table}, int page, int size){
        //分页
     ...
     */
    @Override
    public List<${Table}> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(${keyType} id){
        int count = ${table}Mapper.deleteByPrimaryKey(id);
        return count;
    }
    ...
    public int update(${Table} ${table}){
        int count = ${table}Mapper.updateByPrimaryKey(${table});
        return count;
    }
    ...
    public int add(${Table} ${table}){
        int count = ${table}Mapper.insert(${table});
        return count;
    }
