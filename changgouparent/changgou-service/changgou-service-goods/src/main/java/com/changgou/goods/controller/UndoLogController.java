...
public class UndoLogController {
    ...
    public CommonResult<CommonPage<UndoLog>> findPage(@RequestBody(required = false) @ApiParam(name = "UndoLog对象",value = "传入JSON数据",required = false) UndoLog undoLog, @PathVariable  int page, @PathVariable  int size){
    ...
    public CommonResult<CommonPage<UndoLog>> findPage(@PathVariable  int page, @PathVariable  int size){
