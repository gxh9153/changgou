...
import com.changgou.orders.dao.ReturnOrderItemMapper;
...
public class ReturnOrderItemServiceImpl implements ReturnOrderItemService {
     ...
     */
    @Override
    public List<ReturnOrderItem> findPage(ReturnOrderItem returnOrderItem, int page, int size){
        //分页
     ...
     */
    @Override
    public List<ReturnOrderItem> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(Long id){
        int count = returnOrderItemMapper.deleteByPrimaryKey(id);
        return count;
    }
     ...
     */
    @Override
    public int update(ReturnOrderItem returnOrderItem){
        int count = returnOrderItemMapper.updateByPrimaryKey(returnOrderItem);
        return count;
    }
     ...
     */
    @Override
    public int add(ReturnOrderItem returnOrderItem){
        int count = returnOrderItemMapper.insert(returnOrderItem);
        return count;
    }
