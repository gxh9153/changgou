...
import com.changgou.orders.dao.UndoLogMapper;
...
public class UndoLogServiceImpl implements UndoLogService {
     ...
     */
    @Override
    public List<UndoLog> findPage(UndoLog undoLog, int page, int size){
        //分页
     ...
     */
    @Override
    public List<UndoLog> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(Long id){
        int count = undoLogMapper.deleteByPrimaryKey(id);
        return count;
    }
    ...
    public int update(UndoLog undoLog){
        int count = undoLogMapper.updateByPrimaryKey(undoLog);
        return count;
    }
    ...
    public int add(UndoLog undoLog){
        int count = undoLogMapper.insert(undoLog);
        return count;
    }
