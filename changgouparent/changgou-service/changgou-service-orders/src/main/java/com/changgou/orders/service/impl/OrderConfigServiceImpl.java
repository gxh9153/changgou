...
import com.changgou.orders.dao.OrderConfigMapper;
...
public class OrderConfigServiceImpl implements OrderConfigService {
     ...
     */
    @Override
    public List<OrderConfig> findPage(OrderConfig orderConfig, int page, int size){
        //分页
     ...
     */
    @Override
    public List<OrderConfig> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(Integer id){
        int count = orderConfigMapper.deleteByPrimaryKey(id);
        return count;
    }
    ...
    public int update(OrderConfig orderConfig){
        int count = orderConfigMapper.updateByPrimaryKey(orderConfig);
        return count;
    }
     ...
     */
    @Override
    public int add(OrderConfig orderConfig){
