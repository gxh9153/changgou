...
public class OrderItemServiceImpl implements OrderItemService {
     ...
     */
    @Override
    public List<OrderItem> findPage(OrderItem orderItem, int page, int size){
        //分页
     ...
     */
    @Override
    public List<OrderItem> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(String id){
        int count = orderItemMapper.deleteByPrimaryKey(id);
        return count;
    }
    ...
    public int update(OrderItem orderItem){
        int count = orderItemMapper.updateByPrimaryKey(orderItem);
        return count;
    }
