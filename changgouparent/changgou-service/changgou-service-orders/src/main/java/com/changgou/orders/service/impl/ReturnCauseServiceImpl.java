...
import com.changgou.orders.dao.ReturnCauseMapper;
...
public class ReturnCauseServiceImpl implements ReturnCauseService {
     ...
     */
    @Override
    public List<ReturnCause> findPage(ReturnCause returnCause, int page, int size){
        //分页
     ...
     */
    @Override
    public List<ReturnCause> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(Integer id){
        int count = returnCauseMapper.deleteByPrimaryKey(id);
        return count;
    }
     ...
     */
    @Override
    public int update(ReturnCause returnCause){
        int count = returnCauseMapper.updateByPrimaryKey(returnCause);
        return count;
    }
     ...
     */
    @Override
    public int add(ReturnCause returnCause){
        int count = returnCauseMapper.insert(returnCause);
        return count;
    }
