...
public class OauthClientDetailsServiceImpl implements OauthClientDetailsService {
     ...
     */
    @Override
    public List<OauthClientDetails> findPage(OauthClientDetails oauthClientDetails, int page, int size){
        //分页
     ...
     */
    @Override
    public List<OauthClientDetails> findPage(int page, int size){
        //静态分页
        PageHelper.startPage(page,size);
        //分页查询
    ...
    public int delete(String id){
        int count = oauthClientDetailsMapper.deleteByPrimaryKey(id);
        return count;
    }
    ...
    public int update(OauthClientDetails oauthClientDetails){
        int count = oauthClientDetailsMapper.updateByPrimaryKey(oauthClientDetails);
        return count;
    }
    ...
    public int add(OauthClientDetails oauthClientDetails){
        int count = oauthClientDetailsMapper.insert(oauthClientDetails);
        return count;
    }
